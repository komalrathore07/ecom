...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="box">
      ...
      <div class="container-fluid mx-auto">
        ...
        <a href="{{ route('login') }}"><button class="glow-on-hover mx-auto mt-2" type="button">Login</button></a>
      </div>
    </div>
    ...
    <div class="box">
      ...
      <div class="container mx-auto">
        ...
        <a href="#"><button class="glow-on-hover mx-auto" type="button">About Us</button></a>
      </div>
    </div>
